...
- **Model object handling**
  - Object creation
    ...
    - [LOAD_SECTION_MACRO_STIFFENED ](https://www.consteelsoftware.com/manual/descript-cspi/load_section_macro_stiffened/)→ Loads a stiffened macro section into the section list
    ...
    - [CONVERT_AND_LOAD_SECTIONS ](https://www.consteelsoftware.com/manual/descript-cspi/convert_and_load_sections/)→ Converts and loads sections from section bank
  - Object selection
  ...
  - Object removal
    - [DELETE ](https://www.consteelsoftware.com/manual/descript-cspi/delete/)→ Deletes an object
- **Query tools**
  ...
  - [GET_REFERENCING_OBJECTS ](https://www.consteelsoftware.com/manual/descript-cspi/get_referencing_objects/)→ Gets the IDs of objects referencing the input object
- **Calculation**
...
- **Other**
  ...
  - [TAB ](https://www.consteelsoftware.com/manual/descript-cspi/tab/)→ Changes tab in the main window
  - [MSG_BOX ](https://www.consteelsoftware.com/manual/descript-cspi/msg_box/)→ Pops up a message box
