...
![](img\Generate_Loadcombs_v01.png)

The assignment of the combination type is optional. Default: ULS_PersTrans_CaseA.
...
```
GENERATE LC_IDs_Array LoadCombination
CombinationTypes ULS_PersTrans_CaseA SLS_Characteristic
