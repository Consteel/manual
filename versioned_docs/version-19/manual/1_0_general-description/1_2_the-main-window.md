...
The user defined standards are saved to the following file: C:\\Users\\%USERNAME%_\\AppData\\Local\\ConSteel\\ver\\UserStandards.set_ (Where "C" can be different according to the install drive and "ver" has to be changed to the actual Consteel version number, e.g.:19.0)
